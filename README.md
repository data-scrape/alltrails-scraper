...
**Alltrails Scraper** — AllTrails Scraper - Collect public trail and route metadata for outdoor research

![Python](https://img.shields.io/badge/Python-3.9+-blue?logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-green?logo=opensourceinitiative&logoColor=white)
![Stars](https://img.shields.io/github/stars/data-scrape/alltrails-scraper?style=social)
...
>
> **Search intent:** collect public AllTrails data for research, enrichment, and monitoring workflows. Related topics: travel data, outdoor data, public web data, python, data extraction.

## What this project is for

`alltrails-scraper` is an implementation-focused Python project for collecting public AllTrails data. It is designed around one practical job: turn a query such as **"restaurants in Seattle"** into structured records you can inspect, export, and pass into an automation workflow.
...
```bash
git clone https://github.com/data-scrape/alltrails-scraper.git
cd alltrails-scraper
...
```json
{
  ...
  "result": {
    ...
    "metadata": {"platform": "AllTrails", "category": "Travel & Property Scrapers"}
  }
}
```
